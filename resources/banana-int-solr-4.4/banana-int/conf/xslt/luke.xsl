...
<xsl:stylesheet
    ...
    <xsl:template name="css">
        <style type="text/css">
            ...
            div.history { background: none repeat scroll 0%; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial;}
            table.history { width: auto; vertical-align: bottom; }
            table.history td, table.history th { text-align: center; vertical-align: bottom; border-bottom: 1px solid #ff9933; width: auto; }
            ]]>
        </style>
    </xsl:template>
</xsl:stylesheet>
