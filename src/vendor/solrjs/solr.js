...
(function () {
  ...
  /**
    @class
    <p>The DateHistory facet works with time-based values by building a history across time
    ...
    */
  sjs.DateHistoryFacet = function (name) {

    /**
        The internal facet object.
        @member ejs.DateHistoryFacet
    ...
    return {
      ...
      field: function (fieldName) {
        if (fieldName == null) {
          return facet[name].date_history.field;
        }
      
        facet[name].date_history.field = fieldName;
        return this;
      },
      ...
      keyField: function (fieldName) {
        if (fieldName == null) {
          return facet[name].date_history.key_field;
        }
      
        facet[name].date_history.key_field = fieldName;
        return this;
      },
      ...
      valueField: function (fieldName) {
        if (fieldName == null) {
          return facet[name].date_history.value_field;
        }
      
        facet[name].date_history.value_field = fieldName;
        return this;
      },
      ...
      interval: function (timeInterval) {
        if (timeInterval == null) {
          return facet[name].date_history.interval;
        }
      
        facet[name].date_history.interval = timeInterval;
        return this;
      },
      ...
      timeZone: function (tz) {
        if (tz == null) {
          return facet[name].date_history.time_zone;
        }
      
        facet[name].date_history.time_zone = tz;
        return this;
      },
      ...
      preZone: function (tz) {
        if (tz == null) {
          return facet[name].date_history.pre_zone;
        }
      
        facet[name].date_history.pre_zone = tz;
        return this;
      },
      ...
      preZoneAdjustLargeInterval: function (trueFalse) {
        if (trueFalse == null) {
          return facet[name].date_history.pre_zone_adjust_large_interval;
        }
      
        facet[name].date_history.pre_zone_adjust_large_interval = trueFalse;
        return this;
      },
      ...
      postZone: function (tz) {
        if (tz == null) {
          return facet[name].date_history.post_zone;
        }
      
        facet[name].date_history.post_zone = tz;
        return this;
      },
      ...
      preOffset: function (offset) {
        if (offset == null) {
          return facet[name].date_history.pre_offset;
        }
      
        facet[name].date_history.pre_offset = offset;
        return this;
      },
      ...
      postOffset: function (offset) {
        if (offset == null) {
          return facet[name].date_history.post_offset;
        }
      
        facet[name].date_history.post_offset = offset;
        return this;
      },
      
      /**
            <p>The date history works on numeric values (since time is stored
      ...
      factor: function (f) {
        if (f == null) {
          return facet[name].date_history.factor;
        }
      
        facet[name].date_history.factor = f;
        return this;
      },
      ...
      valueScript: function (scriptCode) {
        if (scriptCode == null) {
          return facet[name].date_history.value_script;
        }
      
        facet[name].date_history.value_script = scriptCode;
        return this;
      },
      ...
      order: function (o) {
        if (o == null) {
          return facet[name].date_history.order;
        }
      
        o = o.toLowerCase();
        if (o === 'time' || o === 'count' || o === 'total') {
          facet[name].date_history.order = o;
        }
      ...
      lang: function (language) {
        if (language == null) {
          return facet[name].date_history.lang;
        }
      
        facet[name].date_history.lang = language;
        return this;
      },
      ...
      params: function (p) {
        if (p == null) {
          return facet[name].date_history.params;
        }
    
        facet[name].date_history.params = p;
        return this;
      },
  ...
  /**
    @class
    <p>The history facet works with numeric data by building a history across intervals
    ...
    */
  sjs.HistoryFacet = function (name) {

    /**
        The internal facet object.
        @member ejs.HistoryFacet
        @property {Object} facet
        */
    var facet = {};
    ...
    return {
      ...
      field: function (fieldName) {
        if (fieldName == null) {
          return facet[name].history.field;
        }
      
        facet[name].history.field = fieldName;
        return this;
      },
      ...
      interval: function (numericInterval) {
        if (numericInterval == null) {
          return facet[name].history.interval;
        }
      
        facet[name].history.interval = numericInterval;
        return this;
      },
      ...
      timeInterval: function (timeInterval) {
        if (timeInterval == null) {
          return facet[name].history.time_interval;
        }
      
        facet[name].history.time_interval = timeInterval;
        return this;
      },
      ...
      from: function (from) {
        if (from == null) {
          return facet[name].history.from;
        }
      
        facet[name].history.from = from;
        return this;
      },
      ...
      to: function (to) {
        if (to == null) {
          return facet[name].history.to;
        }
      
        facet[name].history.to = to;
        return this;
      },
      ...
      valueField: function (fieldName) {
        if (fieldName == null) {
          return facet[name].history.value_field;
        }
      
        facet[name].history.value_field = fieldName;
        return this;
      },
      ...
      keyField: function (fieldName) {
        if (fieldName == null) {
          return facet[name].history.key_field;
        }
      
        facet[name].history.key_field = fieldName;
        return this;
      },
      ...
      valueScript: function (scriptCode) {
        if (scriptCode == null) {
          return facet[name].history.value_script;
        }
      
        facet[name].history.value_script = scriptCode;
        return this;
      },
      ...
      keyScript: function (scriptCode) {
        if (scriptCode == null) {
          return facet[name].history.key_script;
        }
      
        facet[name].history.key_script = scriptCode;
        return this;
      },
      ...
      lang: function (language) {
        if (language == null) {
          return facet[name].history.lang;
        }
      
        facet[name].history.lang = language;
        return this;
      },
      ...
      params: function (p) {
        if (p == null) {
          return facet[name].history.params;
        }
    
        facet[name].history.params = p;
        return this;
      },
      ...
      order: function (o) {
        if (o == null) {
          return facet[name].history.order;
        }
      
        o = o.toLowerCase();
        if (o === 'key' || o === 'count' || o === 'total') {
          facet[name].history.order = o;
        }
  ...
  sjs.Request = function (conf) {
    ...
    return {
      ...
      doRelationshipSearch: function (successcb, errorcb) {
              var queryData = query.solrquery;
              ...
              // query string length. So, use POST to allow as long queries as needed.
              // return sjs.client.get(getRestPath('select'), queryData, successcb, errorcb);
              //alert(getRestPath('select'));

              return sjs.client.post('',queryData, successcb, errorcb);
      }
