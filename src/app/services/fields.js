...
function (angular, _, config) {
  ...
  module.service('fields', function(dashboard, $rootScope, $http, alertSrv) {
    ...
    this.map = function() {
      ...
      var extraHeader = {};
      extraHeader = {"Authorization":"Bearer " + $rootScope.token};
      ...
      return request.then(function(p) {
        ...
        // This hard coded value is just a place holder for extracting fields for the filter list
        ...
        // For Solr, need to implement new mapping
