    ...
    module.controller('query', function ($scope, querySrv, $rootScope) {
        $scope.panelMeta = {
            modals: [{
                ...
                icon: "icon-info-sign",
                partial: "app/partials/search_inspector.html",
                show: true
            }],
            status: "Stable",
            description: "Provide a search bar for free-form queries."
        };
        ...
        var _d = {
            ...
            info_description: 'An advance search for desired data set by single or multiple queries.'
        };
