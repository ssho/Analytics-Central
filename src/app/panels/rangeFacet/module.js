...
function (angular, app, $, _, kbn, moment, timeSeries) {
  ...
  module.controller('rangeFacet', function($scope, $q, querySrv, dashboard, filterSrv,$rootScope) {
    $scope.panelMeta = {
      modals : [
        {
      ...
      status  : "Beta",
      description : "History view across any numeric field using Solr’s range.facet functionality. Works similar to the time series history, allowing selection of ranges, and zooming in/out to the desired numeric range. Range selections in panel are reflected across the entire dashboard."
    };
