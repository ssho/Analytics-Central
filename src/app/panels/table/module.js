...
function (angular, config, app, _, kbn, moment) {
  'use strict';
  ...
  module.controller('table', function($rootScope, $scope, fields, querySrv, dashboard, filterSrv, solrSrv) {
    ...
    var _d = {
      ...
      selectedDataSource:'',
      dataSourceList:[],      
      info_description: 'A text table of the data.'
    };
    ...
    $scope.get_data = function(segment,query_id) {
      ...
      results.then(function(results) {
        ...
        if($scope.query_id === query_id) {
          ...
          fields.list=[];  // make the fields.list = panel.important_fields. fields is a service to get the schemea
          fields.list = $scope.panel.important_fields.slice();
